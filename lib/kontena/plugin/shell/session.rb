...
module Kontena::Plugin
  module Shell
    class Session
      ...
      def run
        puts pastel.blue(File.read(__FILE__).split('__END__').last.rstrip)
        puts pastel.blue("Kontena Shell v#{Kontena::Plugin::Shell::VERSION} (C) Kontena, Inc")
        puts pastel.cyan("Enter 'help' to see a list of commands or 'help <command>' to get help on a specific command.")
...
__END__
 _                 _
| |  _ ___  ____ _| |_ _____ ____  _____
| |_/ ) _ \|  _ (_   _) ___ |  _ \(____ |
|  _ ( |_| | | | || |_| ____| | | / ___ |
|_| \_)___/|_| |_| \__)_____)_| |_\_____|
